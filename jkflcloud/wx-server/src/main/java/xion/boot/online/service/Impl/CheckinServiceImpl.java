...
import xion.boot.online.service.CheckinService;
                    ...
                    try{
                        ...
                        if(elements.size()>0){
                            ...
                            if("高风险".equals(result)){
                                ...
                                message.setSubject("同学" + name + "身处高风险疫情地区警告");
                                message.setText(deptName + "同学" + name + "，" +
                                        DateUtil.format(new Date(), "yyyy年MM月dd日") + "处于" + address +
                                        "，属于新冠疫情高风险地区，请及时填写日报与该学校联系，核实情况！");
