<template>
	<view class="page">
		<swiper autoplay="true" circular="true" interval="1500" duration="1000" class="swiper">
			<swiper-item>
				<image mode="widthFix" src="https://jkfl-1306384632.cos.ap-nanjing.myqcloud.com/sipper-1.png"></image>
			</swiper-item>
			<swiper-item>
				<image mode="widthFix" src="https://jkfl-1306384632.cos.ap-nanjing.myqcloud.com/swipper-2.png"></image>
			</swiper-item>
			<swiper-item>
				<image mode="widthFix" src="https://jkfl-1306384632.cos.ap-nanjing.myqcloud.com/swipper-3.png"></image>
			</swiper-item>
			<swiper-item>
				<image mode="widthFix" src="https://jkfl-1306384632.cos.ap-nanjing.myqcloud.com/swipper-4.png"></image>
			</swiper-item>
			<swiper-item>
				<image mode="widthFix" src="https://jkfl-1306384632.cos.ap-nanjing.myqcloud.com/swipper-5.png"></image>
			</swiper-item>
		</swiper>
		...
		<view class="nav-container">
			...
			<view class="nav-row">
				...
				<view class="nav">
					<image src="../../static/icon-8.png" mode="widthFix" class="icon"></image>
					<text class="name">我的视频</text>
				</view>
				<view class="nav">
					<image src="../../static/icon-20.png" mode="widthFix" class="icon"></image>
					<text class="name">我的图书</text>
				</view>
			</view>
		</view>
