<template>
	<view>
		...
		flash="off" class="camera" @error="error" v-if="showCamera"></camera>
		...
		<view class="notice-container">
			...
			<text class="desc">拍照签到的时候，必须要拍摄自己的正面照片，侧面照片会导致无法识别。
			另外，拍照的时候不要戴墨镜或者帽子，避免影响拍照签到的准确度。</text>
		</view>
	</view>
