<template>
  <a-button @click="handleClick" id="highlighterBarBtn" type="default" title="打开笔记工具">
    <svg
      t="1649236621045"
      class="icon"
...
<script>
export default {
  name: 'HighlighterButton',
  props: ['highlighterBarIsVisible'],
  data() {
    return {
      toggle: true,
    }
  ...
  methods: {
    handleClick() {
      this.$emit('changeHighlighterBarVisible', this.toggle)
