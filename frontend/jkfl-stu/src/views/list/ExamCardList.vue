        ...
        <a-card :hoverable="true" @click="joinExam(item.id, item.date, item.elapse)">
          <a-card-meta>
            ...
            <div class="meta-content" slot="description">
              ...
              <div class="download-btn" @click.stop="downloadBlankPdf(item.id)"><span>下载试卷pdf</span></div>
            </div>
          </a-card-meta>
...
<script>
/* eslint-disable */
import { getExamCardList, getExamRecordList, getExamPaper } from '../../api/exam'
    ...
    downloadBlankPdf(examId) {
      getExamPaper(examId)
        .then((res) => {
          ...
          axios({
            method: 'POST',
            url: 'http://127.0.0.1:7919/api/getblankpdf',
            data: {
