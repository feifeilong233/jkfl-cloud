...
CREATE TABLE `academy`  (
  ...
  `academy_title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_time` datetime NULL DEFAULT NULL,
  `update_time` datetime NULL DEFAULT NULL,
  `deleted` int NULL DEFAULT NULL,
  `version` int NULL DEFAULT NULL,
  `academy_pid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `academy_key` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `admin`  (
  ...
  `admin_role` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_time` datetime NULL DEFAULT NULL,
  `update_time` datetime NULL DEFAULT NULL,
  `deleted` int NULL DEFAULT NULL,
  `version` int NULL DEFAULT NULL,
  `admin_description` varchar(2550) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
INSERT INTO `checkin` VALUES (9, '计算机组成原理', 902123, '2', '1');
...
INSERT INTO `checkin` VALUES (11, '程序设计', 6542478, '2', '1');
...
CREATE TABLE `exam_manage`  (
  ...
  `exam_description` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '考试描述',
  `exam_source` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '考试名称！！！对应paper_look中的paper_look_title',
  ...
  `exam_grade` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '摆设',
  `exam_term` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '摆设\r\n',
  `exam_major` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '摆设',
  `exam_institute` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '摆设',
  `exam_total_score` int NULL DEFAULT NULL COMMENT '总分',
  `exam_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '类型，ez简单，nr中等，hd困难',
  `exam_tips` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '考试贴士，可以写一些考试须知之类的，一般是固定的纪律性文本',
  `create_time` datetime NULL DEFAULT NULL,
  `update_time` datetime NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `exam_manage` VALUES (1501401351320854529, '模拟考试，请认真对待', 'JavaScript基础模拟考试(一)', 4, '2022-04-14 16:00:00', 120, NULL, NULL, NULL, NULL, 125, 'nr', '请将与考试无关物品上交，一旦查到按违规处理。', '2022-03-09 11:35:52', '2022-03-09 11:35:52', 0, 1, 1501180409038512129);
INSERT INTO `exam_manage` VALUES (1501401351320854530, '模拟考试，请认真对待', '前端基础模拟考试(二)', 1, '2022-04-14 15:00:00', 120, NULL, NULL, NULL, NULL, 100, 'nr', '请将与考试无关物品上交，一旦查到按违规处理。', '2022-03-09 11:35:52', '2022-03-09 11:35:52', 0, 1, 1501180422934241281);
...
CREATE TABLE `input_question`  (
  ...
  `iq_subject` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `iq_question` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `iq_answer` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `iq_analysis` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `iq_score` int NULL DEFAULT NULL,
  `iq_level` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `iq_section` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_time` datetime NULL DEFAULT NULL,
  `update_time` datetime NULL DEFAULT NULL,
  `version` int NULL DEFAULT NULL,
  `deleted` tinyint NULL DEFAULT NULL,
...
CREATE TABLE `judge_question`  (
  ...
  `jq_subject` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `jq_question` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `jq_answer` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `jq_analysis` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `jq_score` int NULL DEFAULT NULL,
  `jq_level` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `jq_section` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_time` datetime NULL DEFAULT NULL,
  `update_time` datetime NULL DEFAULT NULL,
  `version` int NULL DEFAULT NULL,
  `deleted` tinyint NULL DEFAULT NULL,
...
INSERT INTO `log` VALUES (1513804653939552258, '管理员登录', '2022-04-12 17:02:09', '2022-04-12 17:02:09', '0', '1');
INSERT INTO `log` VALUES (1513804794419376130, '管理员登录', '2022-04-12 17:02:43', '2022-04-12 17:02:43', '0', '1');
INSERT INTO `log` VALUES (1513804944667734018, '管理员登录', '2022-04-12 17:03:19', '2022-04-12 17:03:19', '0', '1');
INSERT INTO `log` VALUES (1513804948941729794, '查询-用户信息', '2022-04-12 17:03:20', '2022-04-12 17:03:20', '0', '1');
INSERT INTO `log` VALUES (1513805266387628033, '查询-教师列表', '2022-04-12 17:04:35', '2022-04-12 17:04:35', '0', '1');
INSERT INTO `log` VALUES (1513805320523509761, '查询-学生列表', '2022-04-12 17:04:48', '2022-04-12 17:04:48', '0', '1');
INSERT INTO `log` VALUES (1513805324839448577, '查询-教师列表', '2022-04-12 17:04:49', '2022-04-12 17:04:49', '0', '1');
INSERT INTO `log` VALUES (1513805327079206913, '查询-组织列表', '2022-04-12 17:04:50', '2022-04-12 17:04:50', '0', '1');
INSERT INTO `log` VALUES (1513805331915239426, '查询-教师列表', '2022-04-12 17:04:51', '2022-04-12 17:04:51', '0', '1');
INSERT INTO `log` VALUES (1513805334947721217, '查询-组织列表', '2022-04-12 17:04:52', '2022-04-12 17:04:52', '0', '1');
INSERT INTO `log` VALUES (1513805339460792322, '查询-学生列表', '2022-04-12 17:04:53', '2022-04-12 17:04:53', '0', '1');
INSERT INTO `log` VALUES (1513805341222400002, '查询-组织列表', '2022-04-12 17:04:53', '2022-04-12 17:04:53', '0', '1');
INSERT INTO `log` VALUES (1513805344963719170, '查询-教师列表', '2022-04-12 17:04:54', '2022-04-12 17:04:54', '0', '1');
INSERT INTO `log` VALUES (1513805708408549378, '查询-学生列表', '2022-04-12 17:06:21', '2022-04-12 17:06:21', '0', '1');
INSERT INTO `log` VALUES (1513805776289165313, '查询-组织列表', '2022-04-12 17:06:37', '2022-04-12 17:06:37', '0', '1');
INSERT INTO `log` VALUES (1513806005516267521, '查询-日志', '2022-04-12 17:07:32', '2022-04-12 17:07:32', '0', '1');
INSERT INTO `log` VALUES (1513806062873374721, '查询-Swagger文档接口', '2022-04-12 17:07:45', '2022-04-12 17:07:45', '0', '1');
INSERT INTO `log` VALUES (1513806222907043842, '查询-数据库接口', '2022-04-12 17:08:23', '2022-04-12 17:08:23', '0', '1');
INSERT INTO `log` VALUES (1513806277957283841, '查询-数据接口文档', '2022-04-12 17:08:36', '2022-04-12 17:08:36', '0', '1');
INSERT INTO `log` VALUES (1514127770494844929, '管理员登录', '2022-04-13 14:26:06', '2022-04-13 14:26:06', '0', '1');
INSERT INTO `log` VALUES (1514127868612198401, '管理员登录', '2022-04-13 14:26:30', '2022-04-13 14:26:30', '0', '1');
INSERT INTO `log` VALUES (1514127874278703105, '查询-用户信息', '2022-04-13 14:26:31', '2022-04-13 14:26:31', '0', '1');
INSERT INTO `log` VALUES (1514127885930479618, '查询-学生列表', '2022-04-13 14:26:34', '2022-04-13 14:26:34', '0', '1');
INSERT INTO `log` VALUES (1514127887000027137, '查询-教师列表', '2022-04-13 14:26:34', '2022-04-13 14:26:34', '0', '1');
INSERT INTO `log` VALUES (1514127887700475906, '查询-组织列表', '2022-04-13 14:26:34', '2022-04-13 14:26:34', '0', '1');
INSERT INTO `log` VALUES (1514127889122344961, '查询-教师列表', '2022-04-13 14:26:35', '2022-04-13 14:26:35', '0', '1');
INSERT INTO `log` VALUES (1514127937226817538, '查询-学生列表', '2022-04-13 14:26:46', '2022-04-13 14:26:46', '0', '1');
INSERT INTO `log` VALUES (1514127974644203522, '查询-组织列表', '2022-04-13 14:26:55', '2022-04-13 14:26:55', '0', '1');
INSERT INTO `log` VALUES (1514127981787103233, '查询-组织列表', '2022-04-13 14:26:57', '2022-04-13 14:26:57', '0', '1');
INSERT INTO `log` VALUES (1514128010102849537, '查询-组织列表', '2022-04-13 14:27:03', '2022-04-13 14:27:03', '0', '1');
INSERT INTO `log` VALUES (1514128027161083905, '查询-数据接口文档', '2022-04-13 14:27:07', '2022-04-13 14:27:07', '0', '1');
INSERT INTO `log` VALUES (1514128029396647938, '查询-Swagger文档接口', '2022-04-13 14:27:08', '2022-04-13 14:27:08', '0', '1');
INSERT INTO `log` VALUES (1514128035591634946, '查询-数据库接口', '2022-04-13 14:27:09', '2022-04-13 14:27:09', '0', '1');
INSERT INTO `log` VALUES (1514128035591634947, '查询-数据库接口', '2022-04-13 14:27:09', '2022-04-13 14:27:09', '0', '1');
INSERT INTO `log` VALUES (1514128037609095169, '查询-Swagger文档接口', '2022-04-13 14:27:10', '2022-04-13 14:27:10', '0', '1');
INSERT INTO `log` VALUES (1514128047222439938, '查询-数据接口文档', '2022-04-13 14:27:12', '2022-04-13 14:27:12', '0', '1');
INSERT INTO `log` VALUES (1514128053375483906, '查询-用户信息', '2022-04-13 14:27:14', '2022-04-13 14:27:14', '0', '1');
INSERT INTO `log` VALUES (1514128124259221506, '查询-用户信息', '2022-04-13 14:27:31', '2022-04-13 14:27:31', '0', '1');
INSERT INTO `log` VALUES (1514128203523178497, '查询-组织列表', '2022-04-13 14:27:50', '2022-04-13 14:27:50', '0', '1');
INSERT INTO `log` VALUES (1514128205637107714, '查询-学生列表', '2022-04-13 14:27:50', '2022-04-13 14:27:50', '0', '1');
INSERT INTO `log` VALUES (1514128208631840769, '查询-教师列表', '2022-04-13 14:27:51', '2022-04-13 14:27:51', '0', '1');
INSERT INTO `log` VALUES (1514128209747525633, '查询-组织列表', '2022-04-13 14:27:51', '2022-04-13 14:27:51', '0', '1');
INSERT INTO `log` VALUES (1514128286134190082, '查询-教师列表', '2022-04-13 14:28:09', '2022-04-13 14:28:09', '0', '1');
INSERT INTO `log` VALUES (1514128287195348994, '查询-学生列表', '2022-04-13 14:28:09', '2022-04-13 14:28:09', '0', '1');
INSERT INTO `log` VALUES (1514128287937740802, '查询-教师列表', '2022-04-13 14:28:10', '2022-04-13 14:28:10', '0', '1');
INSERT INTO `log` VALUES (1514128290211053570, '查询-学生列表', '2022-04-13 14:28:10', '2022-04-13 14:28:10', '0', '1');
INSERT INTO `log` VALUES (1514128291054108673, '查询-教师列表', '2022-04-13 14:28:10', '2022-04-13 14:28:10', '0', '1');
INSERT INTO `log` VALUES (1514128291326738433, '查询-学生列表', '2022-04-13 14:28:10', '2022-04-13 14:28:10', '0', '1');
INSERT INTO `log` VALUES (1514128292656332801, '查询-教师列表', '2022-04-13 14:28:11', '2022-04-13 14:28:11', '0', '1');
INSERT INTO `log` VALUES (1514128301552451585, '查询-教师列表', '2022-04-13 14:28:13', '2022-04-13 14:28:13', '0', '1');
INSERT INTO `log` VALUES (1514134563895865345, '管理员登录', '2022-04-13 14:53:06', '2022-04-13 14:53:06', '0', '1');
INSERT INTO `log` VALUES (1514134755638472705, '查询-用户信息', '2022-04-13 14:53:52', '2022-04-13 14:53:52', '0', '1');
INSERT INTO `log` VALUES (1514134762764595202, '查询-教师列表', '2022-04-13 14:53:53', '2022-04-13 14:53:53', '0', '1');
INSERT INTO `log` VALUES (1514134769915883521, '查询-学生列表', '2022-04-13 14:53:55', '2022-04-13 14:53:55', '0', '1');
INSERT INTO `log` VALUES (1514134772486991874, '查询-组织列表', '2022-04-13 14:53:56', '2022-04-13 14:53:56', '0', '1');
INSERT INTO `log` VALUES (1514540305551384577, '管理员登录', '2022-04-14 17:45:22', '2022-04-14 17:45:22', '0', '1');
INSERT INTO `log` VALUES (1514540396915908610, '管理员登录', '2022-04-14 17:45:44', '2022-04-14 17:45:44', '0', '1');
INSERT INTO `log` VALUES (1514540402729213953, '查询-用户信息', '2022-04-14 17:45:45', '2022-04-14 17:45:45', '0', '1');
...
CREATE TABLE `multiple_question`  (
  ...
  `mq_subject` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `mq_analysis` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `mq_level` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `mq_score` int NULL DEFAULT NULL,
  `mq_answerA` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `mq_answerB` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `mq_answerC` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `mq_answerD` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `mq_answer` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `mq_question` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_time` datetime NULL DEFAULT NULL,
  `update_time` datetime NULL DEFAULT NULL,
  `version` int NULL DEFAULT NULL,
  `deleted` int NULL DEFAULT NULL,
...
CREATE TABLE `paper_look`  (
  ...
  `paper_look_title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '考试名称',
  ...
  `version` int NULL DEFAULT NULL,
  `deleted` int NULL DEFAULT NULL,
  `paper_teacher_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建考试的名字,这是设计缺陷，应该是id，但是后端耦合了懒得修，插入的时候注意不要重名',
...
CREATE TABLE `program_question`  (
  ...
  `pq_subject` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `pq_question` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `pq_analysis` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `pq_score` int NULL DEFAULT NULL,
  `pq_level` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_time` datetime NULL DEFAULT NULL,
  `update_time` datetime NULL DEFAULT NULL,
  `version` int NULL DEFAULT NULL,
  `deleted` int NULL DEFAULT NULL,
...
CREATE TABLE `school`  (
  ...
  `school_title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_time` datetime NULL DEFAULT NULL,
  `update_time` datetime NULL DEFAULT NULL,
  `deleted` int NULL DEFAULT NULL,
  `version` int NULL DEFAULT NULL,
  `school_pid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `school_key` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `select_question`  (
  ...
  `sq_subject` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sq_question` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sq_answerA` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sq_answerB` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sq_answerC` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sq_answerD` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sq_answer` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sq_analysis` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sq_score` int NULL DEFAULT NULL,
  `sq_section` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sq_level` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_time` datetime NULL DEFAULT NULL,
  `update_time` datetime NULL DEFAULT NULL,
  `version` int NULL DEFAULT NULL,
  `deleted` tinyint NULL DEFAULT NULL,
...
INSERT INTO `select_question` VALUES (1513791845864718338, '程序设计', '一个 C 程序的执行是从（ ）。', 'A.本程序文件的第一个函数开始，到本程序文件的最后一个函数结束', 'B．本程序的 main()函数开始，到本程序文件的最后一个函数结束', 'C．本程序文件的第一函数开始，到本程序 main()函数结束', 'D．本程序的 main()函数开始，到 main()函数结束', 'D', 'C程序的执行是从本程序的main函数开始，到main函数的结束', 2, NULL, '2', '2022-04-12 16:11:16', '2022-04-12 16:11:16', 1, 0);
INSERT INTO `select_question` VALUES (1513791845864718339, '程序设计', '不同于 C++，C 语言源程序的后缀名为（ ）。', 'A．.c', 'B．.obj ', 'C．.txt ', 'D．.cpp', 'A', '无解析', 2, NULL, '2', '2022-04-12 16:11:16', '2022-04-12 16:11:16', 1, 0);
INSERT INTO `select_question` VALUES (1513791845864718340, '计算机组成原理', '算术 / 逻辑运算单元74181ALU可完成', 'A.16种算术运算功能', 'B.16种逻辑运算功能', 'C.4位乘法运算和除法运算功能', 'D.16种算术运算功能和16种逻辑运算功能', 'D', '无解析', 2, NULL, '2', '2022-04-12 16:11:16', '2022-04-12 16:11:16', 1, 0);
INSERT INTO `select_question` VALUES (1513791845864718341, '计算机组成原理', '若用双符号位，则发生正溢的特征是：双符号位为（  ）。\r\n', 'A. 00    	', 'B. 01  ', 'C. 10    ', 'D. 11', 'B', '无解析', 2, NULL, '2', '2022-04-12 16:11:16', '2022-04-12 16:11:16', 1, 0);
INSERT INTO `select_question` VALUES (1513791845864718342, '计算机组成原理', '采用虚拟存贮器的主要目的是（  ）。\r\n', 'A.提高主存贮器的存取速度  ', 'B.扩大主存贮器的存贮空间,并进行自动管理和调度\r\n', 'C.提高外存贮器的存取速度  ', 'D.扩大外存贮器的存贮空间', 'B', '无解析', 2, NULL, '2', '2022-04-12 16:11:16', '2022-04-12 16:11:16', 1, 0);
INSERT INTO `select_question` VALUES (1513791845864718343, '计算机组成原理', 'N+1位定点整数的补码表示的范围是（  ）。\r\n', 'A. -2N和2N-1			', 'B. -2N+1和2N+1-1\r\n', 'C.-2N-1和2N-1			', 'D. -2N+1-1和2N+1-器', 'A', '无解析', 2, NULL, '2', '2022-04-12 16:11:16', '2022-04-12 16:11:16', 1, 0);
INSERT INTO `select_question` VALUES (1513791845864718344, '计算机组成原理', '对于低速输入/输出设备，应当选用的通道是（   ）。\r\n', 'A. 数组多路通道     		', 'B. DMA专用通道\r\n', 'C. 选择通道      		', 'D. 字节多路通道', 'D', '无解析', 2, NULL, '2', '2022-04-12 16:11:16', '2022-04-12 16:11:16', 1, 0);
...
CREATE TABLE `short_answer_question`  (
  ...
  `saq_subject` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `saq_question` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `saq_analysis` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `saq_score` int NULL DEFAULT NULL,
  `saq_level` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_time` datetime NULL DEFAULT NULL,
  `update_time` datetime NULL DEFAULT NULL,
  `version` int NULL DEFAULT NULL,
  `deleted` int NULL DEFAULT NULL,
...
CREATE TABLE `student`  (
  ...
  `stu_email` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '邮箱，摆设',
  `stu_institute` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '废弃',
  `stu_major` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '专业，废弃',
  `stu_identity_card` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '省份证，摆设',
  `deleted` tinyint(1) NULL DEFAULT NULL COMMENT '逻辑删除键值，需要删除用户的时候将deleted置为1 ！',
  `stu_level` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '2' COMMENT '记不得什么了，摆设',
  `stu_sex` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '性别',
  `stu_pwd` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '登陆密码',
  `class_id` bigint NULL DEFAULT NULL COMMENT '班级Id',
  `stu_grade` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '年级，摆设',
  `stu_school` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stu_academy` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stu_description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES (1501180419028512102, '数媒1901-学生-1', '2021-12-01 18:45:45', '2021-12-01 18:45:47', 1, 18115773855, '1356768966@qq.com', '普通三本', '数媒', '320621200107288717', 0, '2', '男', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第一个诞生的学生！', NULL, 1191190101);
INSERT INTO `student` VALUES (1501186950689030146, '数媒1901-学生-2', '2022-03-08 21:23:54', '2022-03-08 21:23:54', 1, 18908055566, 'cadi@live.com', '普通三本', '数媒', NULL, 0, '2', '男', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第2个诞生的学生!', NULL, 1191190102);
INSERT INTO `student` VALUES (1501186950814859265, '数媒1901-学生-3', '2022-03-08 21:23:54', '2022-03-08 21:23:54', 1, 18702874445, 'c5omnx2b@ask.com', '普通三本', '数媒', NULL, 0, '2', '女', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第3个诞生的学生!', NULL, 1191190103);
INSERT INTO `student` VALUES (1501186950814859266, '数媒1901-学生-4', '2022-03-08 21:23:54', '2022-03-08 21:23:54', 1, 17108070072, '7na@yahoo.com', '普通三本', '数媒', NULL, 0, '2', '男', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第4个诞生的学生!', NULL, 1191190104);
INSERT INTO `student` VALUES (1501186950877773825, '数媒1901-学生-5', '2022-03-08 21:23:54', '2022-03-08 21:23:54', 1, 18808447314, 'fm610sl@163.com', '普通三本', '数媒', NULL, 0, '2', '女', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第5个诞生的学生!', NULL, 1191190105);
INSERT INTO `student` VALUES (1501186950877773826, '数媒1901-学生-6', '2022-03-08 21:23:54', '2022-03-08 21:23:54', 1, 13102543083, 'ia1ham@ask.com', '普通三本', '数媒', NULL, 0, '2', '男', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第6个诞生的学生!', NULL, 1191190106);
INSERT INTO `student` VALUES (1501186950944882690, '数媒1901-学生-7', '2022-03-08 21:23:54', '2022-03-08 21:23:54', 1, 17401597768, 'b0gidar@sohu.com', '普通三本', '数媒', NULL, 0, '2', '女', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第7个诞生的学生!', NULL, 1191190107);
INSERT INTO `student` VALUES (1501186951007797250, '数媒1901-学生-8', '2022-03-08 21:23:54', '2022-03-08 21:23:54', 1, 15703974801, 'rou3@googlemail.com', '普通三本', '数媒', NULL, 0, '2', '男', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第8个诞生的学生!', NULL, 1191190108);
INSERT INTO `student` VALUES (1501186951007797251, '数媒1901-学生-9', '2022-03-08 21:23:54', '2022-03-08 21:23:54', 1, 15708442821, '2jdro@live.com', '普通三本', '数媒', NULL, 0, '2', '女', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第9个诞生的学生!', NULL, 1191190109);
INSERT INTO `student` VALUES (1501186951074906114, '数媒1901-学生-10', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 13708110288, 'nz@sina.com', '普通三本', '数媒', NULL, 0, '2', '男', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第10个诞生的学生!', NULL, 1191190110);
INSERT INTO `student` VALUES (1501186951074906115, '数媒1901-学生-11', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 13905677646, 'zw5@live.com', '普通三本', '数媒', NULL, 0, '2', '女', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第11个诞生的学生!', NULL, 1191190111);
INSERT INTO `student` VALUES (1501186951142014978, '数媒1901-学生-12', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 15801778085, 'gp2mnb@sohu.com', '普通三本', '数媒', NULL, 0, '2', '男', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第12个诞生的学生!', NULL, 1191190112);
INSERT INTO `student` VALUES (1501186951142014979, '数媒1901-学生-13', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 18202067493, '7ryw@126.com', '普通三本', '数媒', NULL, 0, '2', '女', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第13个诞生的学生!', NULL, 1191190113);
INSERT INTO `student` VALUES (1501186951209123842, '数媒1901-学生-14', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 15207808313, '4tvl0v@sina.com', '普通三本', '数媒', NULL, 0, '2', '男', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第14个诞生的学生!', NULL, 1191190114);
INSERT INTO `student` VALUES (1501186951209123843, '数媒1901-学生-15', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 15102072032, 'xitr2@0355.net', '普通三本', '数媒', NULL, 0, '2', '女', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第15个诞生的学生!', NULL, 1191190115);
INSERT INTO `student` VALUES (1501186951276232705, '数媒1901-学生-16', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 15305151571, 'gb@3721.net', '普通三本', '数媒', NULL, 0, '2', '男', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第16个诞生的学生!', NULL, 1191190116);
INSERT INTO `student` VALUES (1501186951339147265, '数媒1901-学生-17', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 18904420819, 'yney4h@qq.com', '普通三本', '数媒', NULL, 0, '2', '女', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第17个诞生的学生!', NULL, 1191190117);
INSERT INTO `student` VALUES (1501186951339147266, '数媒1901-学生-18', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 17502738767, '055w@ask.com', '普通三本', '数媒', NULL, 0, '2', '男', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第18个诞生的学生!', NULL, 1191190118);
INSERT INTO `student` VALUES (1501186951406256130, '数媒1901-学生-19', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 17103694748, 'n9x7n@163.com', '普通三本', '数媒', NULL, 0, '2', '女', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第19个诞生的学生!', NULL, 1191190119);
INSERT INTO `student` VALUES (1501186951406256131, '数媒1901-学生-20', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 18503611262, '863@yeah.net', '普通三本', '数媒', NULL, 0, '2', '男', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第20个诞生的学生!', NULL, 1191190120);
INSERT INTO `student` VALUES (1501186951469170690, '数媒1901-学生-21', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 17706458119, '3bkvy9vg@live.com', '普通三本', '数媒', NULL, 0, '2', '女', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第21个诞生的学生!', NULL, 1191190121);
INSERT INTO `student` VALUES (1501186951469170691, '数媒1901-学生-22', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 13400837699, '3hko3@qq.com', '普通三本', '数媒', NULL, 0, '2', '男', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第22个诞生的学生!', NULL, 1191190122);
INSERT INTO `student` VALUES (1501186951532085250, '数媒1901-学生-23', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 18506760585, 'v77o7hk1q@qq.com', '普通三本', '数媒', NULL, 0, '2', '女', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第23个诞生的学生!', NULL, 1191190123);
INSERT INTO `student` VALUES (1501186951532085251, '数媒1901-学生-24', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 13707127962, '06c04s2k5@3721.net', '普通三本', '数媒', NULL, 0, '2', '男', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第24个诞生的学生!', NULL, 1191190124);
INSERT INTO `student` VALUES (1501186951599194113, '数媒1901-学生-25', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 17303430377, '857eawc@hotmail.com', '普通三本', '数媒', NULL, 0, '2', '女', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第25个诞生的学生!', NULL, 1191190125);
INSERT INTO `student` VALUES (1501186951599194114, '数媒1901-学生-26', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 15601403464, '35@263.net', '普通三本', '数媒', NULL, 0, '2', '男', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第26个诞生的学生!', NULL, 1191190126);
INSERT INTO `student` VALUES (1501186951662108673, '数媒1901-学生-27', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 15905613843, '61@ask.com', '普通三本', '数媒', NULL, 0, '2', '女', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第27个诞生的学生!', NULL, 1191190127);
INSERT INTO `student` VALUES (1501186951662108674, '数媒1901-学生-28', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 17208503394, 'ifhav@263.net', '普通三本', '数媒', NULL, 0, '2', '男', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第28个诞生的学生!', NULL, 1191190128);
INSERT INTO `student` VALUES (1501186951725023233, '数媒1901-学生-29', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 13003614694, 'a2z103@ask.com', '普通三本', '数媒', NULL, 0, '2', '女', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第29个诞生的学生!', NULL, 1191190129);
INSERT INTO `student` VALUES (1501186951725023234, '数媒1901-学生-30', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 18704048661, 'fj5ab@163.com', '普通三本', '数媒', NULL, 0, '2', '男', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第30个诞生的学生!', NULL, 1191190130);
INSERT INTO `student` VALUES (1501186951792132098, '数媒1901-学生-31', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 17506110358, 'plb@yahoo.com', '普通三本', '数媒', NULL, 0, '2', '女', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第31个诞生的学生!', NULL, 1191190131);
INSERT INTO `student` VALUES (1501186951855046658, '数媒1901-学生-32', '2022-03-08 21:23:55', '2022-03-08 21:23:55', 1, 15902621776, 'smp9@263.net', '普通三本', '数媒', NULL, 0, '2', '男', '123', 1501180409038512129, '1', '火星大学', '人工智能与计算机学院', '第32个诞生的学生!', NULL, 1191190132);
...
CREATE TABLE `teacher`  (
  ...
  `tea_institute` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '摆设',
  `tea_identity_card` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '摆设',
  `tea_email` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '摆设',
  `tea_type` int NULL DEFAULT NULL COMMENT '老师等级，也是摆设',
  `deleted` tinyint(1) NULL DEFAULT NULL COMMENT '逻辑删除，删除只需要置为1即可！！！',
  `tea_sex` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '性别',
  `tea_pwd` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '密码',
  `tea_role` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '1' COMMENT '角色，为1，虽然是摆设但是不可以改！',
  `tea_job` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '老师等级（type弃用）',
  `tea_school` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `tea_academy` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `tea_description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `tea_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES (2131, '老师-4', '2022-02-24 17:26:03', '2022-03-09 00:20:46', 1, 18908055566, '本科', NULL, 'cadi@live.com', 2, 0, '女', '123', '1', '普通老师', '火星大学', '人工智能与计算机学院', '第七个诞生的用户！', '火星大学的地址', 1501180409038512129);
INSERT INTO `teacher` VALUES (2131231, '老师-5', '2022-02-24 17:28:11', '2022-02-24 17:28:14', 1, 18702874445, '本科', NULL, 'c5omnx2b@ask.com', 2, 0, '女', '123', '1', '普通老师', '火星大学', '人工智能与计算机学院', '第八个诞生的用户！', '火星大学的地址', 1501180422934241281);
INSERT INTO `teacher` VALUES (6525451, '老师-8', '2021-12-01 19:45:21', '2021-12-01 19:45:24', 1, 17108070072, '二流本科', NULL, '7na@yahoo.com', 1, 0, '男', '123', '1', '普通老师', '火星大学', '人工智能与计算机学院', '第一个诞生得用户！', '火星大学的地址', 1501180432992182274);
INSERT INTO `teacher` VALUES (12782187, '老师-2', '2022-02-24 17:23:40', '2022-02-24 17:23:43', 1, 18808447314, '本科', NULL, 'fm610sl@163.com', 2, 0, '男', '123', '1', '普通老师', '火星大学', '物联网工程学院', '第五个诞生的用户！', '火星大学的地址', 1501180441322070018);
INSERT INTO `teacher` VALUES (23412312, '老师-1', '2022-02-24 17:21:35', '2022-02-24 17:21:38', 1, 13102543083, '本科', NULL, 'ia1ham@ask.com', 2, 0, '女', '123', '1', '普通老师', '火星大学', '人工智能与计算机学院', '第四个诞生得用户！', '火星大学的地址', 1501180450687950849);
INSERT INTO `teacher` VALUES (31312344, '老师-9', '2021-12-01 19:43:48', '2021-12-01 19:43:52', 1, 17401597768, '三流本科', NULL, 'b0gidar@sohu.com', 1, 0, '男', '123', '1', '普通老师', '火星大学', '人工智能与计算机学院', '第一个诞生得用户！', '火星大学的地址', 1501180459605041153);
INSERT INTO `teacher` VALUES (34233421, '老师-7', '2022-02-24 17:31:23', '2022-02-24 17:31:25', 1, 15703974801, '本科', NULL, 'rou3@googlemail.com', 2, 0, '男', '123', '1', '普通老师', '不知道起啥名学院', '机械工程学院', '不知道起啥名学院的老师', '不知道起啥名学院的地址', 1501180468182392833);
INSERT INTO `teacher` VALUES (89877654, '老师-6', '2022-02-24 17:28:52', '2022-02-24 17:28:54', 1, 15708442821, '本科', NULL, '2jdro@live.com', 2, 0, '男', '123', '1', '普通老师', '不知道起啥名学院', '数字媒体学院', '时代的眼泪了属于是', '不知道起啥名学院的地址', 1501180477372112898);
INSERT INTO `teacher` VALUES (231123321, '老师-3', '2022-02-24 17:25:37', '2022-02-24 17:25:39', 1, 13708110288, '本科', NULL, 'nz@sina.com', 2, 0, '男', '123', '1', '普通老师', '火星大学', '设计学院', '第六个诞生的用户！', '火星大学的地址', 1501180491259453442);
INSERT INTO `teacher` VALUES (342141241, '老师-10', '2021-12-01 19:46:06', '2021-12-01 19:46:10', 1, 13905677646, '大专', NULL, 'zw5@live.com', 2, 0, '女', '123', '1', '普通老师', '火星大学', '人工智能与计算机学院', '第一个诞生得用户！', '火星大学的地址', 1501180911373524993);
